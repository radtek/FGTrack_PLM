...
namespace HTN.BITS.FGTRACK.TAMPO.Components
{
    public sealed class ServiceProvider : IDisposable
    {
        ...
        ServiceRef.Service_Tampo webService = null;
        ...
        ServiceProvider()
        {
            ...
            webService = new ServiceRef.Service_Tampo();
        ...
        public ServiceRef.Service_Tampo Proxy
        {
            get
            {
                return webService;
