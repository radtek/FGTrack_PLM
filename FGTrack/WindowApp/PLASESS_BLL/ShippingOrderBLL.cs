    ...
    public class ShippingOrderBLL : IDisposable
    {
        ...
        public string InsertShippingOrder(ref ShippingOrder shipOrd, string userid)
        {
            ...
            try
            {
                ...
                ProcParam paramHDR = new ProcParam(11) { ProcedureName = "SO_PACK.SO_HDR_INS" };
                ...
                paramHDR.AddParamInput(9, "strUSER_ID", userid);

                paramHDR.AddParamOutput(10, "RESULTMSG", OracleDbType.Varchar2, 255);
                ...
                OracleString result = (OracleString)paramHDR.ReturnValue(10);
        ...
        public string UpdateShippingOrder(ShippingOrder shipOrd, string userid)
        {
            ...
            try
            {
                ...
                ProcParam paramHDR = new ProcParam(11) { ProcedureName = "SO_PACK.SO_HDR_UPD" };
        ...
        public DataTable GetCompletedSO(string sono, string userid)
        {
            ...
            try
            {
                ProcParam param = new ProcParam(3) { ProcedureName = "SO_PACK.GET_SO_CSV" };
                param.AddParamRefCursor(0, "IO_CURSOR");
                param.AddParamInput(1, "strSO_NO", sono);
                param.AddParamInput(2, "strUSER_ID", userid);
