...
namespace HTN.BITS.FGTRACK.TAMPO
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                bool isCheck = HTN.BITS.FGTRACK.TAMPO.Components.MobileConfiguration.Configuration.Settings["IsCheckVersion"].Equals("True");
        ...
        static Version NewVersion()
        {
            ...
            try
            {
                string xmlURL = HTN.BITS.FGTRACK.TAMPO.Components.MobileConfiguration.Configuration.Settings["URLCheckVersion"].ToString();
        ...
        static bool CheckUpdate()
        {
            try
            {
                ...
                if (File.Exists(fileUpdate))
                {
                    ...
                    proc.StartInfo.Arguments = string.Format("\"{0}\" \"{1}\" \"{2}\"", appPath.ToLower(), "FGTracking_Vertical", startAppName);
                    proc.Start();
