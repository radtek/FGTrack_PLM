...
namespace HTN.BITS.FGTRACK.PRESS.Components
{
    public sealed class ServiceProvider : IDisposable
    {
        ...
        ServiceRef.Service_Press webService = null;
        ...
        ServiceProvider()
        {
            ...
            webService = new ServiceRef.Service_Press();
        ...
        public ServiceRef.Service_Press Proxy
        {
            get
            {
                return webService;
