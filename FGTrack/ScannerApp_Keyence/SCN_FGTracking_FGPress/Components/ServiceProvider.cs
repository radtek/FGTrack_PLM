...
namespace HTN.BITS.FGTRACK.FGPRESS.Components
{
    public sealed class ServiceProvider : IDisposable
    {
        ...
        ServiceRef.Service_FGPRESS webService = null;
        ...
        ServiceProvider()
        {
            ...
            webService = new ServiceRef.Service_FGPRESS();
        ...
        public ServiceRef.Service_FGPRESS Proxy
        {
            get
            {
                return webService;
