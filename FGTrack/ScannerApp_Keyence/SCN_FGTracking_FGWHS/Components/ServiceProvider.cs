...
namespace HTN.BITS.FGTRACK.FGWHS.Components
{
    public sealed class ServiceProvider : IDisposable
    {
        ...
        ServiceRef.Service_FGWHS webService = null;
        ...
        ServiceProvider()
        {
            ...
            webService = new ServiceRef.Service_FGWHS();
        ...
        public ServiceRef.Service_FGWHS Proxy
        {
            get
            {
                return webService;
