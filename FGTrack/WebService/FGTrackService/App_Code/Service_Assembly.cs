...
/// <summary>
/// Summary description for Service_Assembly
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class Service_Assembly : System.Web.Services.WebService
{

    public Service_Assembly()
    {
    ...
    public string CheckValidationUser(string userid)
    {
        ...
        try
        {
            ...
            {
                result = userBLL.Assembly_CheckValidationUser(userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public ProductCard GetProductCardInfo(string serialNo, string processMode, string userid, out string resultMsg) //, out string resultMsg
    {
        ...
        try
        {
            ...
            {
                pdCard = pdBll.Assembly_GetProductCardInfo(serialNo, processMode, userid, out resultMsg);
            }
        }
        catch (Exception ex)
        {
    ...
    public string UpdProductCard(string serialNo, string processMode, string mcNo, int nQty, string userid)
    {
        ...
        try
        {
            using (ProductCardBLL pdBll = new ProductCardBLL())
            {
                result = pdBll.Assembly_UpdProductCard(serialNo, mcNo, processMode, nQty, userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public List<JobLot> GetJobLotList(string jobNo, string userid)
    {
        ...
        try
        {
            ...
            {
                lstJobLot = prodNGBll.Assembly_GetJobLotList(jobNo, userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public ProductCard GetJobLotInfo(string jobNo, int lineNo, string userid)
    {
        ...
        try
        {
            using (ProductCardNGBLL prodNGBll = new ProductCardNGBLL())
            {
                pdCard = prodNGBll.Assembly_GetJobLotInfo(jobNo, lineNo, userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public string UpdateNGQty(string jobNo, int lineNo, int nQty, string userid)
    {
        ...
        try
        {
            ...
            {
                result = aNGBll.Assembly_UpdateNGQty(jobNo, lineNo, nQty, userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public ProductCard GetUpdatePC_QC_Info(string serialNo, string qcStatus, string userid) //
    {
        ...
        try
        {
            ...
            {
                pdCard = pdBll.Assembly_GetUpdatePC_QCInfo(serialNo, qcStatus, userid, out resultMsg);
            }
        }
        catch (Exception ex)
        {
    ...
    public ProductCard GetPC_NGInfo(string serialNo, string userid, out string resultMsg)
    {
        ...
        try
        {
            ...
            {
                pdCard = pdBll.Assembly_GetPC_NGInfo(serialNo, userid, out resultMsg);
            }
        }
        catch (Exception ex)
        {
    ...
    public string UpdateReplenishConfirm(string serialNo, string mode, int qty, string userid)
    {
        ...
        try
        {
            ...
            {
                result = aNGBll.Assembly_UpdateReplenishConfirm(serialNo, mode, qty, userid);
            }
        }
        catch (Exception ex)
        {
    ...
    public ProductCard_Status GetProductCardStatus(string serialNo, string userid, out string resultMsg)
    {
        ...
        try
        {
            ...
            {
                pdCard = pdBll.Assembly_GetProductCardStatus(serialNo, userid, out resultMsg);
            }
        }
        catch (Exception ex)
        {
