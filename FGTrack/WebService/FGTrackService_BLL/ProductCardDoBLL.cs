...
{
    public class ProductCardDoBLL : IDisposable
    {
        ...
        public ProductCardDoBLL()
        {
            //Constructer
        }

        public DeliveryOrderInfo GetDeliveryOrderInfo(string doNo, string userid, out string resultMessage)
        {
            resultMessage = string.Empty;
            DeliveryOrderInfo deliveryOrder = null;

            try
            {
                ProcParam procPara = new ProcParam(4) { ProcedureName = "SCANNER_PACK_MTST_VER.GET_DO_INFO" };
                procPara.AddParamRefCursor(0, "io_cursor");
                procPara.AddParamInput(1, "strDO_NO", doNo);
                ...
                if (OraDataReader.Instance.OraReader.HasRows)
                {
                    ...
                    {
                        deliveryOrder = new DeliveryOrderInfo();

                        deliveryOrder.DO_NO = OraDataReader.Instance.GetString("DO_NO");
                    }
        ...
        public ProductCard GetUpdatePC_MTSTIn(string doNo, string serialNo, string userid, out string resultMessage)
        {
            resultMessage = string.Empty;
        ...
        //public DeliveryOrderInfo GetDeliveryOrderInfoTampo(string doNo, string userid, out string resultMessage)
        //{
        //    resultMessage = string.Empty;
        //    DeliveryOrderInfo deliveryOrder = null;
        ...
        //    try
        //    {
        //        ProcParam procPara = new ProcParam(4) { ProcedureName = "SCANNER_PACK_MTST_TAMPO.GET_DO_INFO" };
        //        procPara.AddParamRefCursor(0, "io_cursor");
        //        procPara.AddParamInput(1, "strDO_NO", doNo);
        //        procPara.AddParamOutput(2, "resultmsg", OracleDbType.Varchar2, 255);
        //        procPara.AddParamInput(3, "strUser_id", userid);
        ...
        public ProductCard GetUpdatePC_MTSTIn_Tampo(string serialNo, string userid, out string resultMessage)
        {
            resultMessage = string.Empty;
            ProductCard pcCard = null;
            ...
            try
            {
                ProcParam procPara = new ProcParam(4) { ProcedureName = "SCANNER_PACK_MTST_TAMPO.GET_UPD_PC_FG_IN" };
                procPara.AddParamRefCursor(0, "io_cursor");
              //  procPara.AddParamInput(1, "strDO_NO", doNo);
                procPara.AddParamInput(1, "strSERIAL_NO", serialNo);
                procPara.AddParamOutput(2, "resultmsg", OracleDbType.Varchar2, 255);
        ...
        public ProductCard GetUpdatePC_MTSTOut_Tampo(string serialNo, string userid, out string resultMessage)
        {
            resultMessage = string.Empty;
            ProductCard pcCard = null;
            ...
            try
            {
                ProcParam procPara = new ProcParam(4) { ProcedureName = "SCANNER_PACK_MTST_TAMPO.GET_UPD_PC_FG_OUT" };
                procPara.AddParamRefCursor(0, "io_cursor");
                procPara.AddParamInput(1, "strSERIAL_NO", serialNo);
                procPara.AddParamOutput(2, "resultmsg", OracleDbType.Varchar2, 255);
                procPara.AddParamInput(3, "strUser_id", userid);
