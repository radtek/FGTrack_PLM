...
namespace HTN.BITS.FGTRACK.DAL
{
    public class ProcParam
    {
        ...
        //public string[] ArrMessageToCheck
        //{
        //    get
        //    {
        //        return this.arrResultCheck;
        //    }
        //}
        ...
        public void AddParamReturn(int index, string paraName, OracleDbType type, int size, int arrBindCount)
        {
            param[index] = new OracleParameter(paraName, type, size, ArrayOf<object>.Create(arrBindCount, null), ParameterDirection.ReturnValue);
            param[index].Size = arrBindCount;
            param[index].ArrayBindSize = ArrayOf<int>.Create(arrBindCount, size);
        }
