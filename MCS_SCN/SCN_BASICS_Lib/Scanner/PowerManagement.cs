...
namespace HTN.BITS.MCS.SCN.LIB.Scanner
{
    public class PowerManagement : IDisposable
    {
        ...
        /// 
        /// </summary>
        private ManualResetEvent mpowerThreadAbort;
        ...
        public void EnableNotifications()
        {
            ...
            if (hMsgQ != IntPtr.Zero && hReq != IntPtr.Zero)
            {
                ...
                //mpowerThreadAbort = new ManualResetEvent(false);
        ...
        private static extern int CEWaitForSingleObject(IntPtr lpHandles, int dwMilliseconds);
