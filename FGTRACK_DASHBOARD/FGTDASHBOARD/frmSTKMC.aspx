<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSTKMC.aspx.cs" Inherits="frmSTKMC" %>
...
//        }
        ...
        function ClearGridCookies() {
            _aspxDelCookie('grvSTK_Machine');
            window.location.reload();
        }
        
        function ColumnColor() {
            var value = this.getItemProperty("STATUS");
            return value = "R" ? "green" : "red";
        }
        ...
        <table style="width: 100%; height: 100%;">
            <tr>
                ...
                <td width="55px" valign="middle">
                    <dx:ASPxImage ID="ASPxImage1" runat="server" ImageUrl="Images/Machine.png" Height="40px" Width="40px">
                    </dx:ASPxImage>
                </td>
                <td width="255px" valign="middle">
                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="STOCK BY MACHINE" ForeColor="White" Font-Names="Century Gothic" Font-Size="18 pt">
                    </dx:ASPxLabel>
                </td>
            </tr>           
        </table>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div id="DivGridview">
                    ...
                    <dx:ASPxGridView ID="grvSTK_Machine" runat="server" AutoGenerateColumns="False" 
                            ClientInstanceName="grid" KeyFieldName="MC_NO" Width="100%" 
                            onhtmldatacellprepared="grvSTK_Machine_HtmlDataCellPrepared" 
                        onafterperformcallback="grvSTK_Machine_AfterPerformCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataDateColumn Caption="M/C#" FieldName="MC_NO" Name="MC_NO" 
                            ...
                            <dx:GridViewDataTextColumn Caption="M/C NAME" FieldName="MACHINE_NAME" Name="MACHINE_NAME" 
                             VisibleIndex="1" Width="24%" Visible="false" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="true">
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataTextColumn>   
                            
                            <dx:GridViewDataTextColumn Caption="PRODUCT TYPE CODE" FieldName="PROD_TYPE_S" Name="PROD_TYPE_S" 
                            ...
                            <dx:GridViewDataTextColumn Caption="PRODUCT TYPE" FieldName="PRODUCT_TYPE" Name="PRODUCT_TYPE" 
                            ...
                            <dx:GridViewDataTextColumn Caption="PRODUCT#" FieldName="PRODUCT_NO" Name="PRODUCT_NO" 
                             VisibleIndex="4" Width="15%" Visible="true" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="false">
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataTextColumn>
                            
                            <dx:GridViewDataTextColumn Caption="PRODUCT NAME" FieldName="PRODUCT_NAME" Name="PRODUCT_NAME" 
                             VisibleIndex="5" Width="14%" Visible="false"
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="false">
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataTextColumn>   
                            
                            <dx:GridViewDataDateColumn Caption="CUSTOMER ID" FieldName="PARTY_ID" Name="PARTY_ID" 
                             VisibleIndex="6" Width="6%" Visible="false" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="false">
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataDateColumn>
                            
                            <dx:GridViewDataTextColumn Caption="CUSTOMER" FieldName="PARTY_NAME" Name="PARTY_NAME" 
                             VisibleIndex="7" Width="14%" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="false">
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataTextColumn>                           
                                                        
                            <dx:GridViewDataTextColumn Caption="PLAN START DATE" FieldName="START_DATE" Name="START_DATE" 
                             VisibleIndex="8" Width="9%" PropertiesTextEdit-DisplayFormatString="{0:dd-MM-yyyy}" 
                            ...
                            <dx:GridViewDataTextColumn Caption="PLAN TO DATE" FieldName="END_DATE" Name="END_DATE" 
                            VisibleIndex="9" Width="9%" PropertiesTextEdit-DisplayFormatString="{0:dd-MM-yyyy}" 
                            CellStyle-HorizontalAlign="Center" CellStyle-ForeColor="White" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="false">
                            <PropertiesTextEdit DisplayFormatString="{0:dd-MM-yyyy}"></PropertiesTextEdit>
                            <CellStyle CssClass="text_overflow"/>
                            </dx:GridViewDataTextColumn>
                            
                            <dx:GridViewDataTextColumn Caption="PLAN QTY" FieldName="PLAN_QTY" Name="PLAN_QTY" 
                            ...
                            <dx:GridViewDataTextColumn Caption="STOCK(PCS)" FieldName="STOCK_PCS" Name="STOCK_PCS" 
                             VisibleIndex="11" Width="7%" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Right" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="true">
                            <PropertiesTextEdit DisplayFormatString="{0:#,##0}">
                            </PropertiesTextEdit>
                            <CellStyle CssClass="text_overflow"/>
                            ...
                            <dx:GridViewDataTextColumn Caption="STOCK(BOX)" FieldName="STOCK_BOX" Name="STOCK_BOX" 
                             VisibleIndex="12" Width="6%" 
                             CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Right" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="18pt" CellStyle-Font-Bold="true">
                            <PropertiesTextEdit DisplayFormatString="{0:#,##0}">
                            </PropertiesTextEdit>
                            <CellStyle CssClass="text_overflow"/>
