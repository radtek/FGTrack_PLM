<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDelivery.aspx.cs" Inherits="frmDelivery" %>
                ...
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" 
                    ...
                    <Columns>    
                        <dx:GridViewDataTextColumn Caption="CUSTOMER" FieldName="PARTY_NAME" Name="PARTY_NAME" 
                         ...
                         CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Left" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="16pt" CellStyle-Font-Bold="false">
                        ...
                        <dx:GridViewBandColumn Name="DT1" Caption="01/07/2013">
                            ...
                            <Columns>                              
                                ...
                                <dx:GridViewDataTextColumn Caption="TIME" FieldName="D1_ETD_TIME" Name="D1_ETD_TIME" 
                                 ...
                                 CellStyle-ForeColor="White" CellStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle" CellStyle-Wrap="False" CellStyle-Font-Size="16pt" CellStyle-Font-Bold="false">
                                <CellStyle CssClass="text_overflow"/>
                                <Settings HeaderFilterMode="CheckedList" />
                                </dx:GridViewDataTextColumn>                               
