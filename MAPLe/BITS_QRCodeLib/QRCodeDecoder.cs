...
using QRCodeImage = HTN.BITS.QRCodeLib.Data.QRCodeImage;
using QRCodeSymbol = HTN.BITS.QRCodeLib.Data.QRCodeSymbol;
using ReedSolomon = HTN.BITS.QRCodeLib.Ecc.ReedSolomon;
using DecodingFailedException = HTN.BITS.QRCodeLib.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = HTN.BITS.QRCodeLib.ExceptionHandler.InvalidDataBlockException;
...
using QRCodeDataBlockReader = HTN.BITS.QRCodeLib.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = HTN.BITS.QRCodeLib.Reader.QRCodeImageReader;
using DebugCanvas = HTN.BITS.QRCodeLib.Util.DebugCanvas;
using DebugCanvasAdapter = HTN.BITS.QRCodeLib.Util.DebugCanvasAdapter;
using QRCodeUtility = HTN.BITS.QRCodeLib.Util.QRCodeUtility;

namespace HTN.BITS.QRCodeLib
{
