...
using InvalidVersionInfoException = HTN.BITS.QRCodeLib.ExceptionHandler.InvalidVersionInfoException;
...
namespace HTN.BITS.QRCodeLib.Reader.Pattern
{
    public class FinderPattern
    {
        ...
        internal static Line[] findLineAcross(bool[][] image)
        {
            ...
            canvas.drawLines(foundLines, HTN.BITS.QRCodeLib.Util.Color_Fields.LIGHTGREEN);
            return foundLines;
        }
        ...
        internal static Point[] getCenter(Line[] crossLines)
        {
            ...
            {
                canvas.drawPolygon(foundPoints, HTN.BITS.QRCodeLib.Util.Color_Fields.RED);
                return foundPoints;
            }
            else
        ...
        internal static int calcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
        {
            ...
            canvas.drawPoints(points, HTN.BITS.QRCodeLib.Util.Color_Fields.RED);
