...
using HTN.BITS.QRCodeLib.Data;
using AlignmentPatternNotFoundException = HTN.BITS.QRCodeLib.ExceptionHandler.AlignmentPatternNotFoundException;
using FinderPatternNotFoundException = HTN.BITS.QRCodeLib.ExceptionHandler.FinderPatternNotFoundException;
using SymbolNotFoundException = HTN.BITS.QRCodeLib.ExceptionHandler.SymbolNotFoundException;
using InvalidVersionException = HTN.BITS.QRCodeLib.ExceptionHandler.InvalidVersionException;
using VersionInformationException = HTN.BITS.QRCodeLib.ExceptionHandler.VersionInformationException;
using HTN.BITS.QRCodeLib.Geom;
using HTN.BITS.QRCodeLib.Reader.Pattern;
using HTN.BITS.QRCodeLib.Util;
using SystemUtils = HTN.BITS.QRCodeLib.Util.SystemUtils;

namespace HTN.BITS.QRCodeLib.Reader
{
    public class QRCodeImageReader
    {
        ...
        internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
        {
            ...
            canvas.drawPoint(bottomRightPoint, HTN.BITS.QRCodeLib.Util.Color_Fields.BLUE);
